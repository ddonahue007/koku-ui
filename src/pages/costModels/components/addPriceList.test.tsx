...
const qr = {
  ...
  submit: messages.CostModelsCreateRate.defaultMessage,
  cancel: messages.Cancel.defaultMessage,
...
describe('add-a-new-rate', () => {
  test('regular rate', () => {
    ...
    expect(getByText(messages.RequiredField.defaultMessage)).toBeTruthy();
    fireEvent.change(container.querySelector(qr.measurement), { target: { value: 'Request' } });
    expect(getByLabelText(qr.supplradio).checked).toBeTruthy();
    fireEvent.click(getByLabelText(qr.infraradio));
    ...
    expect(getByText(messages.CostModelsRateMustBeANumber.defaultMessage)).toBeTruthy();
    ...
    expect(getByText(messages.CostModelsRateMustBeAPositiveNumber.defaultMessage)).toBeTruthy();
    ...
    expect(getByText(messages.CostModelsCreateRate.defaultMessage).closest('button').disabled).toBeFalsy();
  ...
  test('tag rates', () => {
    ...
    expect(queryByText(messages.RequiredField.defaultMessage)).toBeFalsy();
    ...
    expect(getByText(messages.CostModelsCreateRate.defaultMessage).closest('button').disabled).toBeTruthy();
    fireEvent.change(container.querySelector(qr.rateNth(0)), { target: { value: '0.23' } });
  ...
  test('tag rates duplicate tag key', () => {
    ...
    expect(queryByText(messages.CostModelsDuplicate.defaultMessage)).toBeFalsy();
